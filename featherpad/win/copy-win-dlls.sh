...
mkdir dist/FeatherPad/plugins/imageformats
...
cp /mingw64/bin/libglib-2.0-0.dll dist/FeatherPad/
cp /mingw64/bin/libgraphite2.dll dist/FeatherPad/
cp /mingw64/bin/libharfbuzz-0.dll dist/FeatherPad/
cp /mingw64/bin/libhunspell-1.7-0.dll  dist/FeatherPad/
cp /mingw64/bin/libiconv-2.dll dist/FeatherPad/
cp /mingw64/bin/libicudt75.dll dist/FeatherPad/
cp /mingw64/bin/libicuin75.dll dist/FeatherPad/
cp /mingw64/bin/libicuuc75.dll dist/FeatherPad/
cp /mingw64/bin/libintl-8.dll dist/FeatherPad/
cp /mingw64/bin/libmd4c.dll dist/FeatherPad/
cp /mingw64/bin/libpcre2-16-0.dll dist/FeatherPad/
cp /mingw64/bin/libpcre2-8-0.dll dist/FeatherPad/
cp /mingw64/bin/libpng16-16.dll dist/FeatherPad/
cp /mingw64/bin/libstdc++-6.dll dist/FeatherPad/
...
cp -R /mingw64/share/qt6/plugins/imageformats dist/FeatherPad/plugins/
